...
import com.kt.moss.qtest.data.InternetData_I;
 ...
 *
 */
public class OrderDetailInternet_I extends Activity implements OnCheckedChangeListener{
	...
	private TextView i_test_01_tv; // 측정일시
	private TextView i_test_02_tv; // 파장
	private TextView i_test_03_tv; // 파워
	private TextView i_test_04_tv; // Reference
	private TextView i_test_05_tv; // 회선인증결과
	private TextView i_test_06_tv; // FTTH-Real
	private TextView i_test_07_tv; // 다운로드(최대)
	private TextView i_test_07_1_tv; // 다운로드(평균)
	private TextView i_test_07_2_tv; // 다운로드(최소)
	private TextView i_test_08_tv; // 업로드(최대)
	private TextView i_test_08_1_tv; // 업로드(평균)
	private TextView i_test_08_2_tv; // 업로드(최소)
	private TextView i_test_09_tv; // ping 지연(최소)
	private TextView i_test_10_tv; // ping 지연(표준편차)
	private TextView i_test_11_tv; // ping 지연(최대)
	private TextView i_test_12_tv; // 손실율
	private TextView i_test_13_tv; // ping 지연(평균)
	private TextView i_test_14_tv; // UDP 지연(최소)
	private TextView i_test_15_tv; // UDP 지연(표준편차)
	private TextView i_test_16_tv; // UDP 지연(최대)
	private TextView i_test_17_tv; // 손실율
	private TextView i_test_18_tv; // UDP 지연(평균)
	private TextView i_test_19_tv; // CPU부하율
	private TextView i_test_20_tv; // 메모리점유율
	private TextView i_test_21_tv; // 사용자 ip
	private TextView i_test_22_tv; // Momory
	private TextView i_test_23_tv; // 운영체제
	private TextView i_test_24_tv; // 브라우저
	private TextView i_test_25_tv; // CPU
	private TextView i_test_31_tv; // 다운로드 속도 품질 기준(2000 kbps 이상)
	private TextView i_test_32_tv; // 업로드 속도 품질 기준(0kbps 이상
	private TextView i_test_33_tv; // udp 품질 기준(0 ms 이하)
	private TextView i_test_34_tv; // ping 품질 (0 ms 이하)
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// 화면 구성하기
		setContentView(R.layout.order_detail_internet_i);
	...
	public void onResume() {
		...
		mProgressDialog = ProgressDialog.show(OrderDetailInternet_I.this,  "", "인터넷\n상세정보 조회중입니다.");
	...
	private void showTab() {
		...
		if (condition.equals(MossDef.CONDITION_P)) {
			...
			//완료면 윗 상단 버튼 c_layout을 보여줌(측정결과포함된)
			...
			i_test_01_tv  = (TextView)findViewById(R.id.i_test_01_tv);
			i_test_02_tv  = (TextView)findViewById(R.id.i_test_02_tv);
			i_test_03_tv  = (TextView)findViewById(R.id.i_test_03_tv);
			i_test_04_tv  = (TextView)findViewById(R.id.i_test_04_tv);

			sp_speed = (Spinner) this.findViewById(R.id.spinner1);
			i_test_05_tv  = (TextView)findViewById(R.id.i_test_05_tv);
			i_test_06_tv  = (TextView)findViewById(R.id.i_test_06_tv);
			i_test_07_tv  = (TextView)findViewById(R.id.i_test_07_tv);
			i_test_07_1_tv  = (TextView)findViewById(R.id.i_test_07_1_tv);
			i_test_07_2_tv  = (TextView)findViewById(R.id.i_test_07_2_tv);
			i_test_08_tv  = (TextView)findViewById(R.id.i_test_08_tv);
			i_test_08_1_tv  = (TextView)findViewById(R.id.i_test_08_1_tv);
			i_test_08_2_tv  = (TextView)findViewById(R.id.i_test_08_2_tv);
			i_test_09_tv  = (TextView)findViewById(R.id.i_test_09_tv);
			i_test_10_tv  = (TextView)findViewById(R.id.i_test_10_tv);
			i_test_11_tv  = (TextView)findViewById(R.id.i_test_11_tv);
			i_test_12_tv  = (TextView)findViewById(R.id.i_test_12_tv);
			i_test_13_tv  = (TextView)findViewById(R.id.i_test_13_tv);
			i_test_14_tv  = (TextView)findViewById(R.id.i_test_14_tv);
			i_test_15_tv  = (TextView)findViewById(R.id.i_test_15_tv);
			i_test_16_tv  = (TextView)findViewById(R.id.i_test_16_tv);
			i_test_17_tv  = (TextView)findViewById(R.id.i_test_17_tv);
			i_test_18_tv  = (TextView)findViewById(R.id.i_test_18_tv);
			i_test_19_tv  = (TextView)findViewById(R.id.i_test_19_tv);
			i_test_20_tv  = (TextView)findViewById(R.id.i_test_20_tv);
			i_test_21_tv  = (TextView)findViewById(R.id.i_test_21_tv);
			i_test_22_tv  = (TextView)findViewById(R.id.i_test_22_tv);
			i_test_23_tv  = (TextView)findViewById(R.id.i_test_23_tv);
			i_test_24_tv  = (TextView)findViewById(R.id.i_test_24_tv);
			i_test_25_tv  = (TextView)findViewById(R.id.i_test_25_tv);
			i_test_31_tv  = (TextView)findViewById(R.id.i_test_31_tv);
			i_test_32_tv  = (TextView)findViewById(R.id.i_test_32_tv);
			i_test_33_tv  = (TextView)findViewById(R.id.i_test_33_tv);
			i_test_34_tv  = (TextView)findViewById(R.id.i_test_34_tv);
	...
	private void setData(int value) {
		...
		if (data != null) {
			...
			Log.i("OrderDetailInternet_I log", data.toString());
			if (value == 0) {
...
//				i_summary_02_tv.setText(Html.fromHtml("<font color='#ff0000'>"+MossDef.getConditionStr(condition)+"</font>"));
				i_summary_02_tv.setText(Html.fromHtml("<font color='#ff0000'>진행</font>"));
				if(data.getSpeedResult().size() != 0){
					i_summary_02_tv.setText(Html.fromHtml("<font color='#ff0000'>완료</font>"));
				}
				...
				i_customer_04_tv.setText(bodyData.adslTerm.trim());	
				...
				if(data.getResult().size() != 0){
					...
					sp.setOnItemSelectedListener(new OnItemSelectedListener() {
						...
						public void onItemSelected(AdapterView<?> arg0, View arg1,
							...
							i_test_01_tv.setText(resultData.opticTestDate);
							i_test_02_tv.setText(resultData.opticWaveLength + " nm");
							i_test_03_tv.setText(resultData.opticTestQuality + " dBm");

							if(resultData.opticTestQuality != null && resultData.opticTestQuality.startsWith(".")){
								i_test_03_tv.setText("0"+resultData.opticTestQuality + " dBm");
							}
							else if(resultData.opticTestQuality != null && resultData.opticTestQuality.startsWith("-.")){
								i_test_03_tv.setText(resultData.opticTestQuality.replace("-.", "-0.") + " dBm");
							}
							else{
								i_test_03_tv.setText(resultData.opticTestQuality + " dBm");
							}
							i_test_04_tv.setText(resultData.opticTestReference + " dB");
						}
...
//					sp.setPrompt("광레벨 측정");
					...
					i_test_05_tv.setText(bodyData.authcompld_nm);
					i_test_06_tv.setText(bodyData.FTTHFlag);
					...
					if(data.getSpeedResult().size() != 0){
						...
						sp_speed.setOnItemSelectedListener(new OnItemSelectedListener() {
							...
							public void onItemSelected(AdapterView<?> arg0, View arg1,
								...
								//다운로드
								i_test_07_tv.setText(CommonUtil.measured(SpeedresultData.downloadspeedmax));
								i_test_07_1_tv.setText(CommonUtil.measured(SpeedresultData.downloadspeedavg));
								i_test_07_2_tv.setText(CommonUtil.measured(SpeedresultData.downloadspeedmin));
								//업로드
								i_test_08_tv.setText(CommonUtil.measured(SpeedresultData.uploadspeedmax));
								i_test_08_1_tv.setText(CommonUtil.measured(SpeedresultData.uploadspeedavg));
								i_test_08_2_tv.setText(CommonUtil.measured(SpeedresultData.uploadspeedmin));
								//ping (지연/손실)
								i_test_09_tv.setText(SpeedresultData.packdelaytimemin + " ms");
								i_test_10_tv.setText(SpeedresultData.packdelaytimestd + " ms");
								i_test_11_tv.setText(SpeedresultData.packdelaytimemax + " ms");
								i_test_12_tv.setText(SpeedresultData.packlossrate + " %");
								i_test_13_tv.setText(SpeedresultData.packdelayimeavg + " ms");
								//udp (지연/손실)
								i_test_14_tv.setText(SpeedresultData.udpdelaytimemin + " ms");
								i_test_15_tv.setText(SpeedresultData.udpdelaytimestd + " ms");
								i_test_16_tv.setText(SpeedresultData.udpdelaytimemax + " ms");
								i_test_17_tv.setText(SpeedresultData.udplossrate + " %");
								i_test_18_tv.setText(SpeedresultData.udpdelaytimeavg + " ms");
								//기타
								i_test_19_tv.setText(SpeedresultData.cpurate + " %");
								i_test_20_tv.setText(SpeedresultData.memoryrate + " %");
								//고객정보
								i_test_21_tv.setText(SpeedresultData.ip);
								i_test_22_tv.setText(SpeedresultData.memorysize + " Mbytes");
								i_test_23_tv.setText(SpeedresultData.os);
								i_test_24_tv.setText(CommonUtil.nullCheck(SpeedresultData.browser));
								i_test_25_tv.setText(SpeedresultData.cputype);
								//품질정보
								i_test_31_tv.setText(CommonUtil.changeint2000(SpeedresultData.downloadspeedavg));
								if(CommonUtil.changeint2000(SpeedresultData.downloadspeedavg).equals("품질미달")){
									i_test_31_tv.setTextColor(Color.RED);
								}else{
									i_test_31_tv.setTextColor(Color.BLACK);
								}
								i_test_32_tv.setText(CommonUtil.changeint0(SpeedresultData.uploadspeedavg));
								if(CommonUtil.changeint0(SpeedresultData.uploadspeedavg).equals("품질미달")){
									i_test_32_tv.setTextColor(Color.RED);
								}else{
									i_test_32_tv.setTextColor(Color.BLACK);
								}
								i_test_33_tv.setText(CommonUtil.changeint0(SpeedresultData.packdelayimeavg));
								if(CommonUtil.changeint0(SpeedresultData.packdelayimeavg).equals("품질미달")){
									i_test_33_tv.setTextColor(Color.RED);
								}else{
									i_test_33_tv.setTextColor(Color.BLACK);
								}
								i_test_34_tv.setText(CommonUtil.changeint0(SpeedresultData.udpdelaytimeavg));
								if(CommonUtil.changeint0(SpeedresultData.udpdelaytimeavg).equals("품질미달")){
									i_test_34_tv.setTextColor(Color.RED);
								}else{
									i_test_34_tv.setTextColor(Color.BLACK);
								}
							}
...
//						sp_speed.setPrompt("회선 인증 후 인터넷속도측정을 \n해주시기바랍니다.");
	...
	public void onCheckedChanged(RadioGroup group, int checkedId) {       
		...
		case R.id.summaryInfo_p:
			...
			break;
		case R.id.customerInfo_p:  //고객정보
			checkedItem = 1; 
			changedButton(checkedItem);
			break;
		case R.id.fmInfo_p:         //시설정보
			checkedItem = 2;
			changedButton(checkedItem);
			break;

		case R.id.summaryInfo_c:    //요약정보
			checkedItem = 0;
			changedButton(checkedItem);
			break;
		case R.id.customerInfo_c:   //고객정보
			checkedItem = 1; 
			changedButton(checkedItem);
			break; 
		case R.id.fmInfo_c:        //시설정보
			checkedItem = 2;
			changedButton(checkedItem);
			break;
		case R.id.testInfo_c:       //측정결과
			checkedItem = 3;
			changedButton(checkedItem);
			break;	
	...
	private class DetailAsyncTask extends AsyncTask<String, Void, Void> {
		...
		protected Void doInBackground(String... urls) {
			...
			try {
				...
				if (statusLine.getStatusCode() == HttpStatus.SC_OK) {
					...
					data = gson.fromJson(reader, InternetData_I.class); 					
		...
		protected void onCancelled() {
			...
			Toast.makeText(OrderDetailInternet_I.this, "수신 실패", Toast.LENGTH_SHORT).show();
	...
	public void runTest(View v){
		...
		//	   Toast.makeText(OrderDetailInternet_I.this, "광레벨 측정앱 실행", Toast.LENGTH_SHORT).show();
	...
	public void LineTest(View v){
		...
		try {
			...
			Intent intent = new Intent(OrderDetailInternet_I.this, LineTest.class);
	...
	public void speedTest(View v){
		...
		try {
			...
			Intent intent = new Intent(OrderDetailInternet_I.this, SpeedTest.class);
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		if(keyCode == KeyEvent.KEYCODE_BACK) {
			...
			Intent in = new Intent(OrderDetailInternet_I.this, OrderList.class);
			//스피드데이터결과값이 없을시에 전 화면으로 돌아가면 진행 아니면 완료로(140213) 
			if(data.getSpeedResult().size() != 0){
